...
//This is to see the relation of enzyme turnovers with force
...
#define FORCE_MAX 30.0	//Max force applied
...
#define FILE_NAME "results_force2.dat"		//To see where to output data
#define MAX_CATS N		//Number of catenations to insert initially
#define ATP_MAX 2	//Maximum ATP till which readings are taken
...
int main(){
	...
	for(f_each = 0; f_each <= 30; f_each += FORCE_MAX/20){
...
//			cout<<"\t: "<<(float)(MAX_CATS-n_cats)/time1<<endl;
		...
		f1<<f_each<<" "<<avg_cycles<<endl;
		cout<<"ATP: "<<ATP_conc<<"Force: "<<f_each<<" "<<"Cycles per sec: "<<avg_cycles<<endl;
