...
//vs the number of enzyme molecules present in the system
...
#define MAX_ENZYMES 10000		//No. Of enzymes around the latice
#define FORCE 10.0	//Max force applied
...
#define FILE_NAME "results_time10Force.dat"		//To see where to output data
...
int main(){
	...
	for( n_enzymes = 100; n_enzymes <= MAX_ENZYMES; n_enzymes += MAX_ENZYMES/100){	//Never start from 0
...
//			cout<<"\t: "<<(float)(MAX_CATS-n_cats)/time1<<endl;
		...
		f1<<n_enzymes<<" "<<avg_time<<endl;
		cout<<"ATP: "<<ATP_conc<<"Force: "<<f_each<<"Enzymes: "<<n_enzymes<<"Time: "<<avg_time<<endl;
